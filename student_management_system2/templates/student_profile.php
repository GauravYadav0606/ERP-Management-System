                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    } elseif (!empty($att['course_name'])) {
                                        echo htmlspecialchars($att['course_name']); 
                                    } else {
                                        echo "(ID: " . $att['course_id'] . ")";
                                    }
                                ?>
                            </td>
                            <td>
                                <span style="padding: 0.25rem 0.5rem; border-radius: 4px; background: <?php echo $bg; ?>; color: <?php echo $color; ?>; font-size: 0.85rem; font-weight: 600;">
